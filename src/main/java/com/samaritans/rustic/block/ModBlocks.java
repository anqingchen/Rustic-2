...
//    public static final Block ironwood_wall_sign = null;
    ...
    public static void onRegisterBlocks(RegistryEvent.Register<Block> event) {
        ...
        event.getRegistry().registerAll(
                ...
                Util.setup(new RotatedPillarBlock(Block.Properties.from(Blocks.STONE)), "stone_pillar"),
                Util.setup(new RotatedPillarBlock(Block.Properties.from(Blocks.POLISHED_ANDESITE)), "andesite_pillar"),
                Util.setup(new RotatedPillarBlock(Block.Properties.from(Blocks.POLISHED_DIORITE)), "diorite_pillar"),
                Util.setup(new RotatedPillarBlock(Block.Properties.from(Blocks.POLISHED_GRANITE)), "granite_pillar"),
