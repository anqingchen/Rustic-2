...
public class ModCrushingTubRecipe {
    ...
    public static void registerCrushingTubRecipes(RegisterRecipesEvent event) {
        ...
        event.crushingTub().accept(new CrushingTubRecipe(new ResourceLocation(Rustic2.MODID, "olive_oil"), Ingredient.fromItems(Items.BIRCH_SAPLING), new FluidStack(ModFluids.OLIVE_OIL_STILL, 250)));
    }
}
